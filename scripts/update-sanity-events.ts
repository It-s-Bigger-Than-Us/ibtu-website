...
const correctedEvents: Record<string, {
  ...
  "ev-25": { title: "Disaster Relief and Recovery Hub Grand Opening at Baldwin Hills Crenshaw Plaza", jobNumber: "PROG-S25-010-IBTU-FireRelief-HubOpening-041225", status: "Active", displayOnWebsite: true, proofStats: "324 active clients, 7,581 assistance instances, 23.4 avg visits" },
