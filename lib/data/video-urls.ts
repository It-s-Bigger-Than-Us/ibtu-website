...
export const HERO_VIDEOS = {
  ...
  kidsDancing: `${S}/6d07f828d4fa51a21aa9450cfcbb5aac356048d0.mp4`, // vertical
  veniceVert: `${S}/41a7d1afb5e6972ee1e2715c050499c5fd5d520a.mp4`,
  girlsDancing: `${S}/6d07f828d4fa51a21aa9450cfcbb5aac356048d0.mp4`,
}
...
export const PROGRAM_VIDEOS = {
  'fire-relief': {
    ...
    altaCrop: `${S}/49bfe469a78ec84c575feaf57d05255e29386a40.mp4`,
  ...
  'youth-programming': {
    ...
    wrightVert: `${S}/5646929f3c72c14947024874d3f00192cbe0b1e9.mp4`,
  },
  'coastal-care': {
    ...
    vert2: `${S}/3acabd3879d8f54369b42e21129b7252bdbc2cde.mp4`,
  },
  'community-health': {
    mlkParade: `${S}/97b2390db5b764943d77c5ae7cddf7dd53b5bbb0.mp4`,
    ramsEvent: `${S}/5a64425ae72104402a11832f5631277403e0be9e.mp4`,
    mlkCrop: `${S}/ce55540477a4b4b706b84bd0f224f5cb3b485e60.mp4`,
    mlkVert: `${S}/00b5e9e62093ba362e55042869b3a1c03ed8a4e5.mp4`,
    ramsVert: `${S}/5a64425ae72104402a11832f5631277403e0be9e.mp4`,
  },
  'giving-season': {
  ...
  'wellness': {
    ...
    beachVert2: `${S}/11263bd6e5624dab2a457f7953176209cc925e62.mp4`,
  },
}
...
export const VOLUNTEER_VIDEOS = {
  ...
  day3Vert: `${S}/d6e6771d0b18fa735998a58d1006fbdc82aa1357.mp4`,
